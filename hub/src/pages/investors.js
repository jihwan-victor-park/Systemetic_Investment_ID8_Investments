...
import QualityFunnel from '@site/src/components/QualityFunnel';
import ConnectGraph from '@site/src/components/ConnectGraph';
import RubricCards from '@site/src/components/RubricCards';
import styles from './investors.module.css';

export default function Investors() {
  useEffect(() => {
    document.body.classList.add('investor-view');
    return () => document.body.classList.remove('investor-view');
  }, []);
  return (
    <Layout title="For Investors" description="How ID8 uses AI to source and pick deals">
