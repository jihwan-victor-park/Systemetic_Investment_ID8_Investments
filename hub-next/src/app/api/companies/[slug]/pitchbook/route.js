...
import { updateCompanyPitchbookUrl } from '@/lib/companies';
...
export async function PATCH(request, { params }) {
  ...
  const { pitchbookUrl } = await request.json();

  try {
    const result = await updateCompanyPitchbookUrl(slug, pitchbookUrl);
