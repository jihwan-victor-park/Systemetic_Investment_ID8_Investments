...
// Pipeline / Qualified Deals / Deal Summaries subcategories the way
// Docusaurus's `{ type: 'autogenerated', dirName: ... }` used to -- each
// company's `stage` field decides which one of the three it lands in.
//
// The four deal-list categories below are marked `flat: true`: they still
