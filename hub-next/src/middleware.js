...
// the Growth Opportunities Fund I one-pager (a public LP-facing page; the
...
export const config = {
  matcher: [
    '/((?!api/auth|api/admin-market-map|investors$|investors/research/fund-one-pager(?:/|$)|_next/static|_next/image|favicon.ico|fonts|img).*)',
  ],
};
