...
export default function DealsListSection({ companies, basePath, canEdit, defaultSort, searchPlaceholder, emptyMessage }) {
  ...
  const rows = useMemo(
    () => visible.map((c) => companyToRow(c, { basePath, canEdit })),
    [visible, basePath, canEdit],
  );
